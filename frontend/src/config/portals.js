...
export const portals = {
  ...
  teacher: {
    ...
    sidebarNav: [
      ...
      { key: 'cbe-questions', label: 'CBE Questions', icon: 'quiz', path: '/staff/teacher/cbe-questions', status: 'active' },
  ...
  examOfficer: {
    ...
    sidebarNav: [
      { key: 'dashboard', label: 'Dashboard', icon: 'dashboard', path: '/staff/exam-officer/dashboard', status: 'active' },
      { key: 'banks', label: 'Question Banks', icon: 'quiz', path: '/staff/exam-officer/banks', status: 'active' },
    ...
    bottomNav: [
      ...
      { key: 'exams', label: 'CBE Exams', icon: 'laptop_chromebook', path: '/staff/exam-officer/exams', status: 'active' },
      { key: 'monitor', label: 'Monitor', icon: 'monitoring', path: '/staff/exam-officer/monitor', status: 'active' },
      { key: 'more', label: 'More', icon: 'more_horiz', status: 'more' },
    ],
  },
  libraryAttendant: {
