  ...
  return (
    <footer className="bg-secondary text-on-secondary">
      <div className="w-full py-xl px-gutter max-w-container-max mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-xl mb-xl">
          <div>
            <div className="flex items-center gap-sm mb-lg">
              <div className="w-8 h-8 bg-on-secondary/10 flex items-center justify-center rounded">
            ...
            <div className="flex gap-md">
              <a className="w-10 h-10 bg-on-secondary/10 flex items-center justify-center hover:bg-on-secondary/20 transition-colors rounded-full" href="#">
          ...
          <div>
            <h5 className="font-label-md uppercase tracking-widest mb-lg text-tertiary-container">Explore</h5>
          ...
          <div>
            <h5 className="font-label-md uppercase tracking-widest mb-lg text-tertiary-container">Resources</h5>
            <ul className="space-y-md">
          ...
          <div>
            <h5 className="font-label-md uppercase tracking-widest mb-lg text-tertiary-container">Contact</h5>
            <ul className="space-y-md">
        ...
        <div className="border-t border-on-secondary/10 pt-lg flex flex-col md:flex-row justify-between items-center gap-md text-center md:text-left">
