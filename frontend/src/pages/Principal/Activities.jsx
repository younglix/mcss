...
export default function PrincipalActivities() {
  ...
  return (
    <DashboardPageShell portalId="principal" pageTitle="School Activities" title="School Activities" subtitle="Clubs, sports, and societies." loading={loading} error={error} onReload={reload} skeletonCount={1}>
      {data && (
        <div>
