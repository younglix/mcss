...
const ENDPOINTS = { events: '/calendar/events/mine?audience=students' };
...
export default function StudentEvents() {
  ...
  return (
    <AppShell portalId="student" pageTitle="Events & Calendar" user={{ name: user?.full_name || 'Student' }}>
      <div className="space-y-lg sm:space-y-xl">
        <PageHeader title="Events & Calendar" subtitle="Upcoming school events and dates that concern you." />
