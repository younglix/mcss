...
export default function StudentSettings() {
  ...
  return (
    <AppShell portalId="student" pageTitle="Settings" user={{ name: user?.full_name || 'Student' }}>
      <div className="space-y-lg sm:space-y-xl">
        <PageHeader title="Settings" subtitle="Manage your password and active sign-ins." />
