...
export default function BursaryReceipts() {
  ...
  return (
    <DashboardPageShell portalId="bursary" pageTitle="Receipts" title="Receipts" subtitle="Every completed payment, with its receipt number." loading={loading} error={error} onReload={reload} skeletonCount={1}>
      {downloadError && (
