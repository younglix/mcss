...
export default function BursaryFeeStructure() {
  ...
  return (
    <AdminCrudPage
      ...
      title="Fee Structure"
      subtitle="What each fee category costs, per class, per session/term. Student Invoices uses these to generate invoices."
