...
const ENDPOINTS = { slots: '/academics/teaching/timetable' };
...
export default function TeacherTimetable() {
  ...
  return (
    <AppShell portalId="teacher" pageTitle="My Timetable" user={{ name: user?.full_name || 'Teacher' }}>
      <div className="space-y-lg sm:space-y-xl">
        <PageHeader title="My Timetable" subtitle="Your weekly teaching schedule, across every class." />
        ...
        {loading ? (
          ...
          <Card padding="lg"><EmptyState icon="calendar_today" text="No timetable slots have been assigned to you yet." /></Card>
        ) : (
