...
const STATUS_TONE = { submitted: 'secondary', screening: 'secondary', shortlisted: 'warning', interview: 'warning', rejected: 'error', hired: 'success' };
...
export default function HRRecruitment() {
  ...
  return (
    <DashboardPageShell portalId="hr" pageTitle="Recruitment" title="Recruitment" subtitle="Job vacancies, applications, screening, interviews, and shortlisting." loading={loading} error={error} onReload={reload} skeletonCount={1}>
      {data && (
        <div>
          ...
          {postings.length === 0 ? (
            <Card padding="lg"><EmptyState icon="person_search" text="No vacancies posted yet." /></Card>
          ) : (
