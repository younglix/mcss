...
export default function HRPayroll() {
  ...
  return (
    <DashboardPageShell portalId="hr" pageTitle="Payroll" title="Payroll" subtitle="Staff salary structures, allowances, deductions, and monthly payroll runs." loading={loading} error={error} onReload={reload} skeletonCount={2}>
      {data && (
